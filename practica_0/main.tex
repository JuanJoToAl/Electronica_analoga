...
\author{%
    Juan José Tobar Álvarez\thanks{jutobara@unal.edu.co}\and
    David Alejandro Montes Rodríguez\thanks{dmontesr@unal.edu.co}\and
    Estudiante 3\thanks{correo2@unal.edu.co}%
}
...
\subsubsection{Mediciones RMS y DC con variación de la frecuencia}
...
\subsubsection{Comparación de resultados calculados y medidos}
...
\subsubsection{Medición impedancia, comparación y desarrollo teórico del generador de señales}
...
\subsubsection{Medición impedancia, comparación y desarrollo teórico del osciloscopio}
