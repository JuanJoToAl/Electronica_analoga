...
\section{resultados}
\subsection*{Mediciones del circuito resistivo DC}
...
I & 2.18mA & 0.9mA & 1.31mA & 0.91mA \\
  &        &       &        &        \\ \bottomrule
\end{tabular}
\end{table}

\subsection*{Valores RMS para distintas formas de onda}
\begin{table}[]
\begin{tabular}{llll}
\hline
Onda                                 & Valor multímetro TRMS & Valor multímetro de respuesta promedio & Valor de osciloscopio \\ \hline
Seno  $5V_{pp}$ + 1 VDC  500Hz       & 1.725 V               & 1.728 V                                & 1.97 V                \\ \hline
Cuadrada  $5V_{pp}$ + 3V DC  120Hz   & 2.485V                & 2.759 V                                & 3.80 V                \\ \hline
Triangular  $8V_{pp}$ - 4V DC  300Hz & 2.303 V               & 2.226 V                                & 4.64 V                \\ \hline
Cuadrada  $8V_{pp}$ + 2V DC  1kHz    & 3.501 V               & 4 V                                    & 5.109 V               \\ \hline
\end{tabular}
\end{table}
